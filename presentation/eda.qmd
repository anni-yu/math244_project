...
# Save the figure
ggsave("figures/plot5_feminization_scatter_complete_cases.png", width = 9, height = 6, dpi = 300)
```
...
# Save the figure
ggsave("figures/plot6_feminization_scatter_imputed.png", width = 9, height = 6, dpi = 300)
```
